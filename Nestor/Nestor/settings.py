...
SECRET_KEY = 'django-insecure-=!fysr!be#+%15(jyi_c@)j+ur$uomvim90zauzesmr95p$(k_'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'postgres',
        'USER': 'vln2_assignment_groups_18_user',
        'PASSWORD': 'MSvqqCzi0u',
        'HOST': 'verklegt-namskeid-ii.northeurope.cloudapp.azure.com',
        'PORT': '5432',
        'OPTIONS': {
                'options': '-c search_path=vln2_assignment_groups_18'}
    }
}
